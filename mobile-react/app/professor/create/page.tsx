...
export default function CreatePostPage() {
  ...
  const handleCreateProfessor = async () => {
    ...
    try {
      const response = await createUsuario(nome, email, senha, 'admin');
      console.log(' >>> response >>> ' + response);
      Alert.alert('Sucesso', 'Usuário criado com sucesso!');
      // Navega para a tela inicial após criar o usuário
      router.replace('/professor/Professor');
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <TouchableOpacity style={styles.button} onPress={handleCreateProfessor}>
